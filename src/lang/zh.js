export default {
    ...
    logicEntityUniqueDefKeyError: '逻辑模型已经存在，请修改,重复逻辑模型有[{entities}]',
    ...
    extractConfirmLogicEntity: '该逻辑模型已经存在是否继续？',
    extractUpdateEntity: '重命名数据表',
    extractUpdateLogicEntity: '重命名逻辑模型',
    ...
    logicEntity: {
        ...
        group: '所属主题域',
        validate: '代码和名称不能都为空',
        logicEntityUniquenessCheck: '该逻辑模型已存在',
        field: {
            defKey: '属性代码',
            defName: '属性名称',
            primaryKey: '主键',
    ...
    tableBase: {
        ...
        baseConfig: '基础设置',
        savePath: '保存位置',
        savePathFromOther: '从其他数据表/逻辑模型引入',
